...
```{r}
# enzimi
enzimi <- read.xlsx(here('000.gambero2024/R-gambero/input/enzimi/enzimi.xlsx'),
                      sheet = 1)
...
# metalli
metalli <- read.xlsx('000.gambero2024/R-gambero/input/metalli/Pclarkii TrasiMetalli 18-19 verificati.xlsx', sheet=1)
head(metalli)
...
# chimica
chimica <- read.csv('000.gambero2024/R-gambero/input/chimica/chimLudovisi.csv')
```
...
-   meno del 40% della variabilità complessiva
-   buona separazione tra m e f
-   comparazione autunno-inverno con boxplot (vedi sotto, replicabile
    per tutti i metalli)
